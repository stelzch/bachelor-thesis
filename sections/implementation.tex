...
While the recursive formula given in equation \eqref{eq:nodeReduce} already defines a summation algorithm, its implementation in imperative languages would
